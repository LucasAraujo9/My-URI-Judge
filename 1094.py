...
Cada caso de teste contém um inteiro Quantia (1 ≤ Quantia ≤ 15) que representa a quantidade de cobaias utilizadas e
...
for i in range(N):
    numero,cobaia = [str(i)for i in input().split(" ")]
...
total = contR + contS + contC
percetC = (contC * 100)/total
percetR = (contR * 100)/total
percetS = (contS * 100)/total

print("Total: %d cobaias"%total)
print("Total de coelhos: %d"%contC)
print("Total de ratos: %d"%contR)
print("Total de sapos: %d"%contS)
print("Percentual de coelhos: %.2f %%"%percetC)
print("Percentual de ratos: %.2f %%"%percetR)
print("Percentual de sapos: %.2f %%"%percetS)
